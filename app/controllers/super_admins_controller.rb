class SuperAdminsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @super_admin.save
        ...
        superadmin.full_name = @super_admin.login if @super_admin.login.present?
        superadmin.email = @super_admin.email if @super_admin.email.present?
        superadmin.password = @super_admin.password if @super_admin.password.present?
        superadmin.password_confirmation = @super_admin.password if @super_admin.password.present?
  ...
  private
    ...
    def super_admin_params
      params.require(:super_admin).permit(:login, :email, :password)
    end
end
